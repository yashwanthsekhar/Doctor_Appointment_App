...
.btn {
    ...
    background: #1e6cff;  /* same as button color */
    color: white;        /* text becomes white like button */
    font-weight: 700;
    border: none;
    transition: 0.3s;
}
...
.btn:hover {
    background: #4a90ff; /* lighter blue hover like button */
    box-shadow: 0 0 10px rgba(110,182,255,0.5);
}
